...
# 合并两个模块的映射字典
NODE_CLASS_MAPPINGS = {**xy_mappings, **msr_mappings, **video_mappings, **prompt_mappings}
NODE_DISPLAY_NAME_MAPPINGS = {**xy_display, **msr_display, **video_display, **prompt_display}
